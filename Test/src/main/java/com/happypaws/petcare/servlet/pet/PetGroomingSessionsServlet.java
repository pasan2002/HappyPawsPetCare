...
@WebServlet("/owner/pets/grooming-sessions")
public class PetGroomingSessionsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try {
            ...
            // Get grooming sessions for this pet
            List<GroomingSession> sessions = GroomingSessionDAO.findByPetUid(petUid);
            
            req.setAttribute("pet", pet);
            req.setAttribute("sessions", sessions);
            
            RequestDispatcher rd = req.getRequestDispatcher("/views/pet-management/pet-grooming-sessions.jsp");
            rd.forward(req, res);
