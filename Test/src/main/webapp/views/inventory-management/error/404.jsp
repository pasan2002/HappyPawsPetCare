...
<head>
    ...
    <title>Page Not Found - Happy Paws</title>
...
<body class="antialiased text-slate-800 dark:text-slate-100 bg-white dark:bg-slate-950 min-h-screen flex items-center justify-center">
    <div class="text-center">
        <div class="mb-8">
            <div class="text-6xl font-bold text-brand-500 dark:text-brand-400 mb-4">404</div>
            <h1 class="text-2xl font-semibold text-slate-900 dark:text-slate-100 mb-2">Page Not Found</h1>
            <p class="text-slate-600 dark:text-slate-300">The page you are looking for could not be found.</p>
        </div>
